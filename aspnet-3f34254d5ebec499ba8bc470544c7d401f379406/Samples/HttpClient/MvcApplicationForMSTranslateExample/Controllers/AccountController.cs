...
using MvcApplicationForMSTranslateExample.Filters;
using MvcApplicationForMSTranslateExample.Models;

namespace MvcApplicationForMSTranslateExample.Controllers
{
    [Authorize]

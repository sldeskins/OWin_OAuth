...
namespace MvcApplicationForMSTranslateExample.TranslatorServiceSOAP {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="TranslatorServiceSOAP.LanguageService")]
    public interface LanguageService {
        ...
        MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslations", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsResponse")]
        System.Threading.Tasks.Task<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.Translation[] translations, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.Translation[] translations, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        System.Threading.Tasks.Task<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        ...
        MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArrayResponse")]
        System.Threading.Tasks.Task<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        ...
        MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2Response")]
        System.Threading.Tasks.Task<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.LanguageService>, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.LanguageService {
        ...
        public MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
            return base.Channel.GetTranslations(appId, text, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.Translation[] translations, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.Translation[] translations, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
            return base.Channel.AddTranslationArrayAsync(appId, translations, from, to, options);
        }
        
        public MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
            return base.Channel.GetTranslationsArray(appId, texts, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
        ...
        public MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
            return base.Channel.TranslateArrayAsync(appId, texts, from, to, options);
        }
        
        public MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
            return base.Channel.TranslateArray2(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, MvcApplicationForMSTranslateExample.TranslatorServiceSOAP.TranslateOptions options) {
